...
import img from '../../img/images17.jpeg';
...
function AboutApp(props) {
    ...
    return (
        ...
        <Box sx={{
           ...
           {isTextVisible && <Typography variant="h4" sx={{backdropFilter: 'blur(10px)', textShadow: '2px 2px 5px rgba(255, 255, 255, 0.8)',color:'#fff' ,fontWeight:'bold', fontFamily: 'ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,"Apple Color Emoji","Segoe UI Emoji",Segoe UI Symbol,"Noto Color Emoji' }}>
          ...
          {!isTextVisible && (  <>
          <Typography variant="h4" sx={{ color:'#000', mt:'200px',fontWeight: 'bold', fontFamily: 'ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,"Apple Color Emoji","Segoe UI Emoji",Segoe UI Symbol,"Noto Color Emoji' }}>
            Ready to take your channel to the next level?
          </Typography>
          
          <Typography variant="h4" sx={{ color:'#000', mt:'20px',fontWeight: 'bold', fontFamily: 'ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,"Apple Color Emoji","Segoe UI Emoji",Segoe UI Symbol,"Noto Color Emoji' }}>
        ...
        {isTextVisible && <Button variant="contained"  onClick={handleClick} sx={{borderRadius: '50px',padding:'20px','&:hover': {
